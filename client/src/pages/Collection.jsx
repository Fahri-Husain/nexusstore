...
import { HiX, HiArrowLeft, HiSearch } from 'react-icons/hi';
    ...
    <div className="collection-page">
      <div className="collection-hero">
        ...
        <div className="container">
          <h1 className="collection-title">Koleksi Game</h1>
          <p className="collection-subtitle">
            {searchQuery 
              ? `Hasil pencarian untuk "${searchQuery}"`
              : 'Temukan dan jelajahi katalog lengkap game premium kami'
            }
          </p>
        </div>
      </div>
      ...
      <section className="collection-content container">
        <form className="collection-search-bar" onSubmit={handleSearchSubmit}>
